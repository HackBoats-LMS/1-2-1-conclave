...
export function SuccessAlert({ initialMessage }: { initialMessage: string }) {
  ...
  return (
    <div className={`${isWarning ? "bg-amber-400" : "bg-[#BEF03C]"} border-2 border-[#0D2421] p-4 rounded-2xl shadow-[4px_4px_0px_#0D2421] flex items-center justify-between gap-3 transition-all duration-300 relative z-20`}>
